...
print("{}".format(crayons.green('This was made by 3kh0_!')))
...
# SETTINGS
webhookurl = 'https://discord.com/api/webhooks/1074415275480457267/rOaVaYg9_EddTW4EsAYyekZEzoCiUINs0UZ6HPHRsPQ7zx3C_b5rN5kde66OQ0vKY1qV' 
...
for x in range(1, int(amount) + 1):
    ...
    time.sleep(1) # Cooldown because of rate limited.
